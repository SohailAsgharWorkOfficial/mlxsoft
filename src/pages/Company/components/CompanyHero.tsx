      ...
      <div className="mx-auto flex max-w-6xl flex-col gap-12 px-6 lg:flex-row lg:items-center lg:gap-16">
        <div className="flex-1 space-y-6">
          ...
          <p className="max-w-xl text-[15px] leading-relaxed text-[#4D4D4D]">
            We are a full-service product team delivering digital experiences across web and mobile with quality,
            reliability, and friendly collaboration.
          </p>
        ...
        <div className="relative flex-1">
          ...
          >
            <img src={HeroImage} alt="Team" className="h-full w-full object-cover" />
          </div>

          <div className="absolute -right-8 bottom-10 rounded-[18px] bg-white px-5 py-4 shadow-lg shadow-slate-900/12">
            <p className="text-[12px] font-semibold text-[#0EAF66]">3k+</p>
            <p className="text-[11px] text-[#4D4D4D]">Happy Clients</p>
          </div>
        </div>
      </div>
